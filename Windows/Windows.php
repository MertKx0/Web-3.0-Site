...
<div class="sidebar">
    ...
    <ul class="side-menu">
        ...
        <li><a href="Uygulamalar.php"><i class='bx bx-analyse'></i>Uygulamalar</a></li>
        <li class="active"><a href="Windows.php"><i class='bx bxl-windows'></i>Windows-İSO</a></li>
...
<div class="content">
    ...
    <nav>
        ...
        <script>
            function yonlendir() {
                window.location.href = "../Dark/Windows/Dark-Windows.php";
            }
        </script>
